          ...
          <td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table width="709" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td height="470" align="center" valign="top" bgcolor="#F6F9FE">
                <form name="form1" method="post" action="MyStudenthao.action">
                  ...
                  <tr>
                    ...
                    <td width="72%">查询：
                      <select name="Student_DomitoryID" id="Student_DomitoryID">
                        ...
                        <option value="${ds.domitory_ID}">${ds.domitory_Name}</option>
                        </c:forEach>
                      </select>
                      学号:
                      ...
                      <input name="Building_ID" type="text" class="noshow" id="Building_ID" value="${s.domitory_BuildingID}"></td>
                  </tr>
                </table>
              </form>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr align="center"  class="t1">
                    ...
                    <tr align="center">
                      ...
                      <td>${ds.domitory_Number}</td>
                      <td align="center"><a href="LogAdd.action?Student_ID=${s.student_ID}">缺寝登记</a></td>
                    </tr>
                     </c:forEach>
                     </c:forEach>
                </table></td>
