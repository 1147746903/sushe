                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td><select name="Domitory_NullNumber" id="Domitory_NullNumber">
                        <option value="">请选择</option>
                        <option value="4">4人寝</option>
                        <option value="6">6人寝</option>
                        <option value="8">8人寝</option>
                    </select>
                    </td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>备注：</td>
                      <td><textarea name="Domitory_Remarks" id="Domitory_Remarks" cols="45" rows="5"></textarea></td>
                  </tr>
                  <tr>
                    <td height="30">&nbsp;</td>
