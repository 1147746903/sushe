              ...
              <td height="470" align="center" valign="top" bgcolor="#F6F9FE">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td width="67%"><input name="Building_ID" type="text" class="noshow" id="Building_ID" value="${building.building_ID}"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>名称：</td>
                    <td><input name="Building_Name" type="text" class="text2" id="Building_Name" value="${building.building_Name}"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>简介：</td>
                    <td><textarea name="Building_Introduction" id="Building_Introduction" cols="45" rows="5">${building.building_Introduction}</textarea></td>
                  </tr>
                  <tr>
                    <td height="30">&nbsp;</td>
