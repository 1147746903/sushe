          ...
          <td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table width="709" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td height="470" align="center" valign="top" bgcolor="#F6F9FE">
                <form name="form1" method="post" action="${pageContext.request.contextPath}/StudentUpdateSave.action" onSubmit="return mycheck()" >
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td width="67%"><input name="Student_ID" type="text" class="noshow" id="Student_ID" value="${student.student_ID}"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>学号：</td>
                    <td><input name="Student_Username" type="text" class="text2" id="Student_Username" value="${student.student_Username}"></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td><input name="Student_Name" type="text" class="text2" id="Student_Name" value="${student.student_Name}"></td>
                  </tr>
                  <tr>
                    ...
                    <td><select name="Student_Sex" id="Student_Sex">
                      ...
                      <option value="男"
                              <c:if test="${student.student_Sex eq '男'}">selected</c:if>
                      >男
                      </option>
                      <option value="女"
                              <c:if test="${student.student_Sex eq '女'}">selected</c:if>
                      >女
                      </option>
                    </select></td>
                  </tr>
                  <tr>
                    ...
                    <td><input name="Student_Class" type="text" class="text2" id="Student_Class" value="${student.student_Class}"></td>
                  </tr>
                  <tr>
                    <td height="30">&nbsp;</td>
