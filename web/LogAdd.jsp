              ...
              <form name="form1" method="post" action="LogAddSave.action" onSubmit="return mycheck()" >
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td width="67%">${SD.student_Username}
                      <label for="Log_StudentID"></label>
                      <input name="Log_StudentID" type="text" class="noshow" id="Log_StudentID" value="${SD.student_ID}">
                      <input name="Log_TeacherID" type="text" class="noshow" id="Log_TeacherID" value="${SESSION.teacher_ID}">
                    </td>
                  </tr>
                  <tr>
