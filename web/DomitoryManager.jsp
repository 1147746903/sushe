          ...
          <td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table width="709" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td height="470" align="center" valign="top" bgcolor="#F6F9FE">
                <form name="form1" method="post" action="DomitoryManagerSelect.action">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <c:forEach items="${domitory}" var="db">
                    <tr align="center">
                      <td height="25" align="center">${db.building_Name}</td>
                      <td>${db.domitory_Name}</td>
                      <td>${db.domitory_Number}</td>
                      <td align="center">${db.domitory_NullNumber}</td>
                      <td align="center">${db.domitory_Remarks}</td>
                      <td align="center">
                        <a href="DSManager.action?Domitory_ID=${db.domitory_ID}">学生</a>
                        <a href="DomitoryUpdate.action?Domitory_ID=${db.domitory_ID}">修改</a>
                        <a href="DomitoryDel.action?Domitory_ID=${db.domitory_ID}" onClick="return confirm('确定要删除该宿舍吗？')">删除</a></td>
                    </tr>
                  </c:forEach>
                </table>
              </td>
