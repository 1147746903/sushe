          ...
          <td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table width="709" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td height="470" align="center" valign="top" bgcolor="#F6F9FE">
                <form name="form1" method="post" action="${pageContext.request.contextPath}/TeacherUpdateSave.action" onSubmit="return mycheck()" >
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td width="67%"><input name="Teacher_ID" type="text" class="noshow" id="Teacher_ID" value="${teacher.teacher_ID}"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>用户名：</td>
                    <td><input name="Teacher_Username" type="text" class="text2" id="Teacher_Username" value="${teacher.teacher_Username}"></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td><input name="Teacher_Name" type="text" class="text2" id="Teacher_Name" value="${teacher.teacher_Name}"></td>
                  </tr>
                  <tr>
                    ...
                    <td><select name="Teacher_Sex" id="Teacher_Sex">
                      ...
                      <option value="男"
                              <c:if test="${teacher.teacher_Sex eq '男'}">selected</c:if>
                      >男
                      </option>
                      <option value="女"
                              <c:if test="${teacher.teacher_Sex eq '女'}">selected</c:if>
                      >女
                      </option>
                    </select></td>
                  </tr>
                  <tr>
                    ...
                    <td><input name="Teacher_Tel" type="text" class="text2" id="Teacher_Tel" value="${teacher.teacher_Tel}"></td>
                  </tr>
                  <tr>
                    <td height="30">&nbsp;</td>
